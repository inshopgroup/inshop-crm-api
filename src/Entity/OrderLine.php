 ...
 *          "get"={
 *              "security"="is_granted('ROLE_ORDER_LINE_LIST')"
 *          },
 *          "post"={
 *              "security"="is_granted('ROLE_ORDER_LINE_CREATE')"
 *          }
 *     },
 *     itemOperations={
 *          "get"={
 *              "security"="is_granted('ROLE_ORDER_LINE_SHOW')"
 *          },
 *          "put"={
 *              "security"="is_granted('ROLE_ORDER_LINE_UPDATE')"
 *          },
 *          "delete"={
 *              "security"="is_granted('ROLE_ORDER_LINE_DELETE')"
 *          }
 *     })
 */
class OrderLine
