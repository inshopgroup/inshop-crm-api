 ...
 *          "get"={
 *              "security"="is_granted('ROLE_PURCHASE_ORDER_LINE_STATUS_LIST')"
 *          },
 *          "post"={
 *              "security"="is_granted('ROLE_PURCHASE_ORDER_LINE_STATUS_CREATE')"
 *          }
 *     },
 *     itemOperations={
 *          "get"={
 *              "security"="is_granted('ROLE_PURCHASE_ORDER_LINE_STATUS_SHOW')"
 *          },
 *          "put"={
 *              "security"="is_granted('ROLE_PURCHASE_ORDER_LINE_STATUS_UPDATE')"
 *          },
 *          "delete"={
 *              "security"="is_granted('ROLE_PURCHASE_ORDER_LINE_STATUS_DELETE')"
 *          }
 *     })
