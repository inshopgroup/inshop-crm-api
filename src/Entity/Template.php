 ...
 *          "get"={
 *              "security"="is_granted('ROLE_TEMPLATE_LIST')"
 *          },
 *          "post"={
 *              "security"="is_granted('ROLE_TEMPLATE_CREATE')"
 *          }
 *     },
 *     itemOperations={
 *          "get"={
 *              "security"="is_granted('ROLE_TEMPLATE_SHOW')"
 *          },
 *          "put"={
 *              "security"="is_granted('ROLE_TEMPLATE_UPDATE')"
 *          },
 *          "delete"={
 *              "security"="is_granted('ROLE_TEMPLATE_DELETE')"
 *          }
 *     })
