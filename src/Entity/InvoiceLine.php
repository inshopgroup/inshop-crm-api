 ...
 *          "get"={
 *              "security"="is_granted('ROLE_INVOICE_LINE_LIST')"
 *          },
 *          "post"={
 *              "security"="is_granted('ROLE_INVOICE_LINE_CREATE')"
 *          }
 *     },
 *     itemOperations={
 *          "get"={
 *              "security"="is_granted('ROLE_INVOICE_LINE_SHOW')"
 *          },
 *          "put"={
 *              "security"="is_granted('ROLE_INVOICE_LINE_UPDATE')"
 *          },
 *          "delete"={
 *              "security"="is_granted('ROLE_INVOICE_LINE_DELETE')"
 *          }
 *     })
 */
class InvoiceLine
