 ...
 *          "get"={
 *              "security"="is_granted('ROLE_WAREHOUSE_LIST')"
 *          },
 *          "post"={
 *              "security"="is_granted('ROLE_WAREHOUSE_CREATE')"
 *          }
 *     },
 *     itemOperations={
 *          "get"={
 *              "security"="is_granted('ROLE_WAREHOUSE_SHOW')"
 *          },
 *          "put"={
 *              "security"="is_granted('ROLE_WAREHOUSE_UPDATE')"
 *          },
 *          "delete"={
 *              "security"="is_granted('ROLE_WAREHOUSE_DELETE')"
 *          }
 *     })
